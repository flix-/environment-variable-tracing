...
bool
DataFlowFacts::isMemoryLocationEqual(const llvm::Value* fact, const llvm::Value* memLocation) {
...
bool
DataFlowFacts::isValueEqual(const llvm::Value* fact, const llvm::Value* inst) {
  return fact == inst;
}
