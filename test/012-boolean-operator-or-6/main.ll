...
entry:
  ...
  br i1 %tobool, label %lor.end, label %lor.rhs, !dbg !18
...
lor.end:                                          ; preds = %lor.rhs, %entry
  ...
  %lor.ext = zext i1 %0 to i32, !dbg !18
  store i32 %lor.ext, i32* %taint, align 4, !dbg !16
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/test/012-boolean-operator-or-6")
!2 = !{}
