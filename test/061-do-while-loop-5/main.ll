...
do.body:                                          ; preds = %do.cond2, %entry
  ...
  br label %do.body1, !dbg !20, !llvm.loop !21
...
do.cond:                                          ; preds = %do.body1
  ...
  br i1 %tobool, label %do.body1, label %do.end, !dbg !25, !llvm.loop !21

do.end:                                           ; preds = %do.cond
  %0 = load i32, i32* %a, align 4, !dbg !27
  store i32 %0, i32* %rc, align 4, !dbg !28
  br label %do.cond2, !dbg !29

do.cond2:                                         ; preds = %do.end
  %call3 = call i32 (...) @foo(), !dbg !30
  %tobool4 = icmp ne i32 %call3, 0, !dbg !29
  br i1 %tobool4, label %do.body, label %do.end5, !dbg !29, !llvm.loop !15
...
!20 = !DILocation(line: 11, column: 9, scope: !18)
!21 = distinct !{!21, !20, !22}
!22 = !DILocation(line: 13, column: 32, scope: !18)
!23 = !DILocation(line: 12, column: 15, scope: !24)
!24 = distinct !DILexicalBlock(scope: !18, file: !1, line: 11, column: 12)
!25 = !DILocation(line: 13, column: 9, scope: !24)
!26 = !DILocation(line: 13, column: 18, scope: !18)
!27 = !DILocation(line: 14, column: 14, scope: !18)
!28 = !DILocation(line: 14, column: 12, scope: !18)
!29 = !DILocation(line: 15, column: 5, scope: !18)
