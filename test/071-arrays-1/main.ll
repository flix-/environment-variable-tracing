...
entry:
  ...
  %arrayidx1 = getelementptr inbounds [2 x i32], [2 x i32]* %numbers, i64 0, i64 1, !dbg !20
  store i32 1, i32* %arrayidx1, align 4, !dbg !21
  call void @llvm.dbg.declare(metadata i32* %rc, metadata !22, metadata !15), !dbg !23
  %arrayidx2 = getelementptr inbounds [2 x i32], [2 x i32]* %numbers, i64 0, i64 0, !dbg !24
  %0 = load i32, i32* %arrayidx2, align 4, !dbg !24
  store i32 %0, i32* %rc, align 4, !dbg !23
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/test/071-arrays-1")
!2 = !{}
...
!21 = !DILocation(line: 10, column: 16, scope: !7)
!22 = !DILocalVariable(name: "rc", scope: !7, file: !1, line: 12, type: !10)
!23 = !DILocation(line: 12, column: 9, scope: !7)
!24 = !DILocation(line: 12, column: 14, scope: !7)
!25 = !DILocation(line: 14, column: 12, scope: !7)
