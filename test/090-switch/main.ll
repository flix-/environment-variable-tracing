...
entry:
  ...
  store i32 %call, i32* %rc, align 4, !dbg !13
  %0 = load i32, i32* %rc, align 4, !dbg !15
...
sw.default:                                       ; preds = %entry
  store i32 3, i32* %rc, align 4, !dbg !22
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/test/090-switch")
!2 = !{}
...
!17 = !DILocation(line: 11, column: 12, scope: !18)
!18 = distinct !DILexicalBlock(scope: !7, file: !1, line: 9, column: 17)
!19 = !DILocation(line: 12, column: 9, scope: !18)
!20 = !DILocation(line: 14, column: 12, scope: !18)
!21 = !DILocation(line: 15, column: 9, scope: !18)
!22 = !DILocation(line: 17, column: 12, scope: !18)
!23 = !DILocation(line: 18, column: 5, scope: !18)
!24 = !DILocation(line: 20, column: 5, scope: !7)
