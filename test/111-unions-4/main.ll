...
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %a, metadata !35, metadata !28), !dbg !36
  %u3 = bitcast %union.u1* %u to %union.u2*, !dbg !37
  %u4 = bitcast %union.u2* %u3 to %union.u3*, !dbg !38
  %tainted = bitcast %union.u3* %u4 to i8**, !dbg !39
  %0 = load i8*, i8** %tainted, align 8, !dbg !39
  store i8* %0, i8** %a, align 8, !dbg !36
  ret i32 0, !dbg !40
}
