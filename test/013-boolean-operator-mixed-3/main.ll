...
lor.rhs:                                          ; preds = %land.lhs.true, %entry
  %call3 = call i32 @getenv(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i32 0, i32 0)), !dbg !18
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/test/013-boolean-operator-mixed-3")
!2 = !{}
