...
land.end:                                         ; preds = %land.rhs, %while.cond
  %0 = phi i1 [ false, %while.cond ], [ %tobool2, %land.rhs ]
  br i1 %0, label %while.body, label %while.end, !dbg !14

while.body:                                       ; preds = %land.end
  store i32 100, i32* %rc, align 4, !dbg !18
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/test/051-while-loop-1")
!2 = !{}
...
!16 = !DILocation(line: 9, column: 27, scope: !7)
!17 = !DILocation(line: 9, column: 30, scope: !7)
!18 = !DILocation(line: 10, column: 12, scope: !19)
!19 = distinct !DILexicalBlock(scope: !7, file: !1, line: 9, column: 37)
!20 = distinct !{!20, !14, !21}
!21 = !DILocation(line: 11, column: 5, scope: !7)
!22 = !DILocation(line: 13, column: 12, scope: !7)
