...
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %a, metadata !17, metadata !14), !dbg !18
  %0 = load i8*, i8** %taint, align 8, !dbg !19
  store i8* %0, i8** %a, align 8, !dbg !18
  call void @llvm.dbg.declare(metadata i8** %b, metadata !20, metadata !14), !dbg !21
  %1 = load i8*, i8** %a, align 8, !dbg !22
  store i8* %1, i8** %b, align 8, !dbg !21
  store i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i32 0, i32 0), i8** %a, align 8, !dbg !23
  %2 = load i8*, i8** %a, align 8, !dbg !24
  store i8* %2, i8** %b, align 8, !dbg !25
  ret i32 0, !dbg !26
}
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/test/002-copy-delete")
!2 = !{}
...
!17 = !DILocalVariable(name: "a", scope: !7, file: !1, line: 11, type: !12)
!18 = !DILocation(line: 11, column: 11, scope: !7)
!19 = !DILocation(line: 11, column: 15, scope: !7)
!20 = !DILocalVariable(name: "b", scope: !7, file: !1, line: 13, type: !12)
!21 = !DILocation(line: 13, column: 11, scope: !7)
!22 = !DILocation(line: 13, column: 15, scope: !7)
!23 = !DILocation(line: 14, column: 7, scope: !7)
!24 = !DILocation(line: 16, column: 9, scope: !7)
!25 = !DILocation(line: 16, column: 7, scope: !7)
!26 = !DILocation(line: 18, column: 5, scope: !7)
