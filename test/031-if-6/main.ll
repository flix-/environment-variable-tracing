...
if.end12:                                         ; preds = %if.end11, %if.then3
  br label %if.end14, !dbg !40

if.else13:                                        ; preds = %entry
  store i32 100, i32* %ret, align 4, !dbg !41
  br label %if.end14
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/test/031-if-6")
!2 = !{}
...
!40 = !DILocation(line: 20, column: 5, scope: !19)
!41 = !DILocation(line: 21, column: 13, scope: !42)
!42 = distinct !DILexicalBlock(scope: !15, file: !1, line: 20, column: 12)
!43 = !DILocation(line: 24, column: 12, scope: !7)
!44 = !DILocation(line: 24, column: 5, scope: !7)
