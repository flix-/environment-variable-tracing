...
entry:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %dst, i8* %0, i64 1, i32 1, i1 false), !dbg !20
  ret i32 0, !dbg !21
}
...
!19 = !DILocation(line: 13, column: 18, scope: !7)
!20 = !DILocation(line: 13, column: 5, scope: !7)
!21 = !DILocation(line: 15, column: 5, scope: !7)
