...
while.end:                                        ; preds = %while.cond1
  ...
  br label %while.cond, !dbg !14, !llvm.loop !25

while.end5:                                       ; preds = %while.cond
  %0 = load i32, i32* %rc, align 4, !dbg !27
  ret i32 %0, !dbg !28
}
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/test/051-while-loop-4")
!2 = !{}
