...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  br i1 %tobool, label %for.body, label %for.end, !dbg !20
...
for.end:                                          ; preds = %for.cond
  %2 = load i32, i32* %rc, align 4, !dbg !29
  ret i32 %2, !dbg !30
}
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/test/041-for-loop-1")
!2 = !{}
...
!21 = !DILocation(line: 10, column: 14, scope: !22)
!22 = distinct !DILexicalBlock(scope: !19, file: !1, line: 9, column: 42)
!23 = !DILocation(line: 10, column: 12, scope: !22)
!24 = !DILocation(line: 11, column: 5, scope: !22)
!25 = !DILocation(line: 9, column: 38, scope: !19)
!26 = !DILocation(line: 9, column: 5, scope: !19)
!27 = distinct !{!27, !20, !28}
!28 = !DILocation(line: 11, column: 5, scope: !15)
!29 = !DILocation(line: 13, column: 12, scope: !7)
!30 = !DILocation(line: 13, column: 5, scope: !7)
