...
lor.rhs:                                          ; preds = %lor.lhs.false
  %call3 = call i32 @getenv(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0)), !dbg !18
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/test/012-boolean-operator-or-3")
!2 = !{}
...
!18 = !DILocation(line: 8, column: 35, scope: !7)
