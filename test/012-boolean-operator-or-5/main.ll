...
entry:
  ...
  br i1 %tobool, label %lor.end, label %lor.lhs.false, !dbg !15

lor.lhs.false:                                    ; preds = %entry
  %call1 = call i32 @getenv(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0)), !dbg !16
  %tobool2 = icmp ne i32 %call1, 0, !dbg !16
  br i1 %tobool2, label %lor.rhs, label %lor.end, !dbg !17

lor.rhs:                                          ; preds = %lor.lhs.false
  %call3 = call i32 (...) @foo(), !dbg !18
  %tobool4 = icmp ne i32 %call3, 0, !dbg !17
  br label %lor.end, !dbg !17

lor.end:                                          ; preds = %lor.rhs, %lor.lhs.false, %entry
  %0 = phi i1 [ true, %lor.lhs.false ], [ true, %entry ], [ %tobool4, %lor.rhs ]
  %lor.ext = zext i1 %0 to i32, !dbg !17
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/test/012-boolean-operator-or-5")
!2 = !{}
...
!15 = !DILocation(line: 8, column: 23, scope: !7)
!16 = !DILocation(line: 8, column: 27, scope: !7)
!17 = !DILocation(line: 8, column: 40, scope: !7)
!18 = !DILocation(line: 8, column: 43, scope: !7)
