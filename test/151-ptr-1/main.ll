...
entry:
  ...
  call void @llvm.dbg.declare(metadata i8*** %b, metadata !17, metadata !14), !dbg !19
  store i8** %a, i8*** %b, align 8, !dbg !19
  %0 = load i8**, i8*** %b, align 8, !dbg !20
  store i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i8** %0, align 8, !dbg !21
  call void @llvm.dbg.declare(metadata i8*** %not_tainted, metadata !22, metadata !14), !dbg !23
  %1 = load i8**, i8*** %b, align 8, !dbg !24
  store i8** %1, i8*** %not_tainted, align 8, !dbg !23
  ret i32 0, !dbg !25
}
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/test/151-ptr-1")
!2 = !{}
...
!17 = !DILocalVariable(name: "b", scope: !7, file: !1, line: 9, type: !18)
!18 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !12, size: 64)
!19 = !DILocation(line: 9, column: 12, scope: !7)
!20 = !DILocation(line: 11, column: 6, scope: !7)
!21 = !DILocation(line: 11, column: 8, scope: !7)
!22 = !DILocalVariable(name: "not_tainted", scope: !7, file: !1, line: 13, type: !18)
