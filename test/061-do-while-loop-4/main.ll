...
do.body1:                                         ; preds = %do.cond, %do.body
  store i32 1, i32* %rc, align 4, !dbg !22
  br label %do.cond, !dbg !24

do.cond:                                          ; preds = %do.body1
  %call = call i32 @getenv(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0)), !dbg !25
  %tobool = icmp ne i32 %call, 0, !dbg !24
  br i1 %tobool, label %do.body1, label %do.end, !dbg !24, !llvm.loop !20

do.end:                                           ; preds = %do.cond
  br label %do.cond2, !dbg !26

do.cond2:                                         ; preds = %do.end
  %call3 = call i32 (...) @foo(), !dbg !27
  %tobool4 = icmp ne i32 %call3, 0, !dbg !26
  br i1 %tobool4, label %do.body, label %do.end5, !dbg !26, !llvm.loop !15

do.end5:                                          ; preds = %do.cond2
  %0 = load i32, i32* %rc, align 4, !dbg !28
  ret i32 %0, !dbg !29
}
...
!25 = !DILocation(line: 13, column: 18, scope: !18)
!26 = !DILocation(line: 14, column: 5, scope: !18)
