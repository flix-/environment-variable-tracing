...
entry:
  ...
  store i32 %cond, i32* %no_taint, align 4, !dbg !13
  ret i32 0, !dbg !16
}
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/020-ternary-operator")
!2 = !{}
...
!11 = !DILocalVariable(name: "no_taint", scope: !7, file: !1, line: 8, type: !10)
!12 = !DIExpression()
!13 = !DILocation(line: 8, column: 9, scope: !7)
!14 = !DILocation(line: 8, column: 20, scope: !7)
