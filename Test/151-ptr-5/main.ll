...
entry:
  ...
  %3 = load i8*, i8** %u, align 8, !dbg !34
  %4 = load i8***, i8**** %ppt, align 8, !dbg !35
  %5 = load i8**, i8*** %4, align 8, !dbg !36
  store i8* %3, i8** %5, align 8, !dbg !37
  call void @llvm.dbg.declare(metadata i8*** %not_tainted, metadata !38, metadata !14), !dbg !39
  %6 = load i8***, i8**** %ppt, align 8, !dbg !40
  %7 = load i8**, i8*** %6, align 8, !dbg !41
  store i8** %7, i8*** %not_tainted, align 8, !dbg !39
  ret i32 0, !dbg !42
}
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/151-ptr-5")
!2 = !{}
...
!34 = !DILocation(line: 27, column: 13, scope: !7)
!35 = !DILocation(line: 27, column: 7, scope: !7)
!36 = !DILocation(line: 27, column: 6, scope: !7)
!37 = !DILocation(line: 27, column: 11, scope: !7)
!38 = !DILocalVariable(name: "not_tainted", scope: !7, file: !1, line: 29, type: !17)
!39 = !DILocation(line: 29, column: 12, scope: !7)
!40 = !DILocation(line: 29, column: 27, scope: !7)
!41 = !DILocation(line: 29, column: 26, scope: !7)
