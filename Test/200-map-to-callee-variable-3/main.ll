...
; Function Attrs: noinline nounwind optnone uwtable
define void @foo(i8* %tainted_foo) #0 !dbg !24 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %tainted_foo.addr, metadata !27, metadata !13), !dbg !28
  call void @llvm.dbg.declare(metadata i8** %also_tainted, metadata !29, metadata !13), !dbg !30
  %0 = load i8*, i8** %tainted_foo.addr, align 8, !dbg !31
  store i8* %0, i8** %also_tainted, align 8, !dbg !30
  call void @llvm.dbg.declare(metadata i8** %not_tainted, metadata !32, metadata !13), !dbg !33
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8** %not_tainted, align 8, !dbg !33
  %1 = load i8*, i8** %tainted_foo.addr, align 8, !dbg !34
  %2 = load i8*, i8** %not_tainted, align 8, !dbg !35
  call void @bar(i8* %1, i8* %2), !dbg !36
  ret void, !dbg !37
}
...
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %tainted_main, metadata !42, metadata !13), !dbg !43
  %call = call i8* @getenv(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i32 0, i32 0)), !dbg !44
  store i8* %call, i8** %tainted_main, align 8, !dbg !43
  %0 = load i8*, i8** %tainted_main, align 8, !dbg !45
  call void @foo(i8* %0), !dbg !46
  ret i32 0, !dbg !47
}
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/200-map-to-callee-variable-3")
!2 = !{}
...
!24 = distinct !DISubprogram(name: "foo", scope: !1, file: !1, line: 11, type: !25, isLocal: false, isDefinition: true, scopeLine: 12, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!25 = !DISubroutineType(types: !26)
!26 = !{null, !10}
!27 = !DILocalVariable(name: "tainted_foo", arg: 1, scope: !24, file: !1, line: 11, type: !10)
!28 = !DILocation(line: 11, column: 11, scope: !24)
!29 = !DILocalVariable(name: "also_tainted", scope: !24, file: !1, line: 13, type: !10)
!30 = !DILocation(line: 13, column: 11, scope: !24)
!31 = !DILocation(line: 13, column: 26, scope: !24)
!32 = !DILocalVariable(name: "not_tainted", scope: !24, file: !1, line: 14, type: !10)
!33 = !DILocation(line: 14, column: 11, scope: !24)
!34 = !DILocation(line: 15, column: 9, scope: !24)
!35 = !DILocation(line: 15, column: 22, scope: !24)
!36 = !DILocation(line: 15, column: 5, scope: !24)
!37 = !DILocation(line: 16, column: 1, scope: !24)
!38 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 19, type: !39, isLocal: false, isDefinition: true, scopeLine: 20, isOptimized: false, unit: !0, variables: !2)
!39 = !DISubroutineType(types: !40)
!40 = !{!41}
!41 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!42 = !DILocalVariable(name: "tainted_main", scope: !38, file: !1, line: 21, type: !10)
!43 = !DILocation(line: 21, column: 11, scope: !38)
!44 = !DILocation(line: 21, column: 26, scope: !38)
!45 = !DILocation(line: 22, column: 9, scope: !38)
!46 = !DILocation(line: 22, column: 5, scope: !38)
