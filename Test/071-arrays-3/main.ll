...
entry:
  ...
  %arrayidx4 = getelementptr inbounds [2 x i32], [2 x i32]* %numbers, i64 0, i64 0, !dbg !26
  store i32 0, i32* %arrayidx4, align 4, !dbg !27
  %arrayidx5 = getelementptr inbounds [2 x i32], [2 x i32]* %numbers, i64 0, i64 0, !dbg !28
  %2 = load i32, i32* %arrayidx5, align 4, !dbg !28
  %arrayidx6 = getelementptr inbounds [2 x i32], [2 x i32]* %numbers, i64 0, i64 1, !dbg !29
  store i32 %2, i32* %arrayidx6, align 4, !dbg !30
  %arrayidx7 = getelementptr inbounds [2 x i32], [2 x i32]* %numbers, i64 0, i64 1, !dbg !31
  %3 = load i32, i32* %arrayidx7, align 4, !dbg !31
  store i32 %3, i32* %rc, align 4, !dbg !32
  %4 = load i32, i32* %rc, align 4, !dbg !33
  ret i32 %4, !dbg !34
}
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/071-arrays-3")
!2 = !{}
...
!26 = !DILocation(line: 14, column: 5, scope: !7)
!27 = !DILocation(line: 14, column: 16, scope: !7)
!28 = !DILocation(line: 15, column: 18, scope: !7)
!29 = !DILocation(line: 15, column: 5, scope: !7)
!30 = !DILocation(line: 15, column: 16, scope: !7)
!31 = !DILocation(line: 17, column: 10, scope: !7)
!32 = !DILocation(line: 17, column: 8, scope: !7)
!33 = !DILocation(line: 19, column: 12, scope: !7)
!34 = !DILocation(line: 19, column: 5, scope: !7)
