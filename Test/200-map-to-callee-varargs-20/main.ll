...
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %t1, metadata !33, metadata !21), !dbg !36
...
vaarg.end:                                        ; preds = %vaarg.in_mem, %vaarg.in_reg
  ...
  store i8* %6, i8** %t1, align 8, !dbg !36
  call void @llvm.dbg.declare(metadata i8** %nt1, metadata !38, metadata !21), !dbg !39
...
vaarg.end10:                                      ; preds = %vaarg.in_mem6, %vaarg.in_reg4
  ...
  store i8* %13, i8** %nt1, align 8, !dbg !39
  call void @llvm.dbg.declare(metadata i8** %t2, metadata !41, metadata !21), !dbg !42
...
vaarg.end21:                                      ; preds = %vaarg.in_mem17, %vaarg.in_reg15
  ...
  store i8* %20, i8** %t2, align 8, !dbg !42
  call void @llvm.dbg.declare(metadata i8** %nt2, metadata !44, metadata !21), !dbg !45
...
vaarg.end32:                                      ; preds = %vaarg.in_mem28, %vaarg.in_reg26
  ...
  store i8* %27, i8** %nt2, align 8, !dbg !45
  call void @llvm.dbg.declare(metadata i8** %nt3, metadata !47, metadata !21), !dbg !48
  %28 = load %struct.__va_list_tag*, %struct.__va_list_tag** %args.addr, align 8, !dbg !49
  %gp_offset_p34 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %28, i32 0, i32 0, !dbg !49
  %gp_offset35 = load i32, i32* %gp_offset_p34, align 8, !dbg !49
  %fits_in_gp36 = icmp ule i32 %gp_offset35, 40, !dbg !49
  br i1 %fits_in_gp36, label %vaarg.in_reg37, label %vaarg.in_mem39, !dbg !49

vaarg.in_reg37:                                   ; preds = %vaarg.end32
  %29 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %28, i32 0, i32 3, !dbg !49
  %reg_save_area38 = load i8*, i8** %29, align 8, !dbg !49
  %30 = getelementptr i8, i8* %reg_save_area38, i32 %gp_offset35, !dbg !49
  %31 = bitcast i8* %30 to i8**, !dbg !49
  %32 = add i32 %gp_offset35, 8, !dbg !49
  store i32 %32, i32* %gp_offset_p34, align 8, !dbg !49
  br label %vaarg.end43, !dbg !49

vaarg.in_mem39:                                   ; preds = %vaarg.end32
  %overflow_arg_area_p40 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %28, i32 0, i32 2, !dbg !49
  %overflow_arg_area41 = load i8*, i8** %overflow_arg_area_p40, align 8, !dbg !49
  %33 = bitcast i8* %overflow_arg_area41 to i8**, !dbg !49
  %overflow_arg_area.next42 = getelementptr i8, i8* %overflow_arg_area41, i32 8, !dbg !49
  store i8* %overflow_arg_area.next42, i8** %overflow_arg_area_p40, align 8, !dbg !49
  br label %vaarg.end43, !dbg !49

vaarg.end43:                                      ; preds = %vaarg.in_mem39, %vaarg.in_reg37
  %vaarg.addr44 = phi i8** [ %31, %vaarg.in_reg37 ], [ %33, %vaarg.in_mem39 ], !dbg !49
  %34 = load i8*, i8** %vaarg.addr44, align 8, !dbg !49
  store i8* %34, i8** %nt3, align 8, !dbg !48
  ret i32 -1, !dbg !50
}

; Function Attrs: noinline nounwind optnone uwtable
define i32 @fake_BIO_printf(i32 %n, ...) #0 !dbg !51 {
entry:
  %n.addr = alloca i32, align 4
  %args = alloca [1 x %struct.__va_list_tag], align 16
  %rc = alloca i32, align 4
  store i32 %n, i32* %n.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %n.addr, metadata !54, metadata !21), !dbg !55
  call void @llvm.dbg.declare(metadata [1 x %struct.__va_list_tag]* %args, metadata !56, metadata !21), !dbg !63
  %arraydecay = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %args, i32 0, i32 0, !dbg !64
  ...
  %arraydecay2 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %args, i32 0, i32 0, !dbg !68
  %call = call i32 @fake_BIO_vprintf(i32 %0, %struct.__va_list_tag* %arraydecay2), !dbg !69
  store i32 %call, i32* %rc, align 4, !dbg !66
  %arraydecay3 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %args, i32 0, i32 0, !dbg !70
  %arraydecay34 = bitcast %struct.__va_list_tag* %arraydecay3 to i8*, !dbg !70
  call void @llvm.va_end(i8* %arraydecay34), !dbg !70
  %1 = load i32, i32* %rc, align 4, !dbg !71
  ret i32 %1, !dbg !72
}
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/200-map-to-callee-varargs-20")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 5.0.1 (tags/RELEASE_501/final 348479)"}
!7 = distinct !DISubprogram(name: "fake_BIO_vprintf", scope: !1, file: !1, line: 19, type: !8, isLocal: false, isDefinition: true, scopeLine: 20, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
...
!20 = !DILocalVariable(name: "n", arg: 1, scope: !7, file: !1, line: 19, type: !10)
!21 = !DIExpression()
!22 = !DILocation(line: 19, column: 22, scope: !7)
!23 = !DILocalVariable(name: "args", arg: 2, scope: !7, file: !1, line: 19, type: !11)
!24 = !DILocation(line: 19, column: 33, scope: !7)
!25 = !DILocation(line: 21, column: 22, scope: !7)
!26 = !DILocation(line: 21, column: 12, scope: !7)
!27 = !DILocation(line: 21, column: 5, scope: !7)
...
!33 = !DILocalVariable(name: "t1", scope: !28, file: !1, line: 9, type: !34)
!34 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !35, size: 64)
!35 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!36 = !DILocation(line: 9, column: 11, scope: !28)
!37 = !DILocation(line: 9, column: 16, scope: !28)
!38 = !DILocalVariable(name: "nt1", scope: !28, file: !1, line: 10, type: !34)
!39 = !DILocation(line: 10, column: 11, scope: !28)
!40 = !DILocation(line: 10, column: 17, scope: !28)
!41 = !DILocalVariable(name: "t2", scope: !28, file: !1, line: 11, type: !34)
!42 = !DILocation(line: 11, column: 11, scope: !28)
!43 = !DILocation(line: 11, column: 16, scope: !28)
!44 = !DILocalVariable(name: "nt2", scope: !28, file: !1, line: 12, type: !34)
!45 = !DILocation(line: 12, column: 11, scope: !28)
!46 = !DILocation(line: 12, column: 17, scope: !28)
!47 = !DILocalVariable(name: "nt3", scope: !28, file: !1, line: 13, type: !34)
!48 = !DILocation(line: 13, column: 11, scope: !28)
!49 = !DILocation(line: 13, column: 17, scope: !28)
!50 = !DILocation(line: 15, column: 5, scope: !28)
!51 = distinct !DISubprogram(name: "fake_BIO_printf", scope: !1, file: !1, line: 25, type: !52, isLocal: false, isDefinition: true, scopeLine: 26, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!52 = !DISubroutineType(types: !53)
!53 = !{!10, !10, null}
!54 = !DILocalVariable(name: "n", arg: 1, scope: !51, file: !1, line: 25, type: !10)
!55 = !DILocation(line: 25, column: 21, scope: !51)
!56 = !DILocalVariable(name: "args", scope: !51, file: !1, line: 27, type: !57)
!57 = !DIDerivedType(tag: DW_TAG_typedef, name: "va_list", file: !58, line: 30, baseType: !59)
!58 = !DIFile(filename: "/home/sebastian/documents/programming/llvm/jail/llvm501-debug/lib/clang/5.0.1/include/stdarg.h", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/200-map-to-callee-varargs-20")
!59 = !DIDerivedType(tag: DW_TAG_typedef, name: "__builtin_va_list", file: !1, line: 27, baseType: !60)
!60 = !DICompositeType(tag: DW_TAG_array_type, baseType: !12, size: 192, elements: !61)
!61 = !{!62}
!62 = !DISubrange(count: 1)
!63 = !DILocation(line: 27, column: 13, scope: !51)
!64 = !DILocation(line: 28, column: 5, scope: !51)
!65 = !DILocalVariable(name: "rc", scope: !51, file: !1, line: 30, type: !10)
!66 = !DILocation(line: 30, column: 9, scope: !51)
!67 = !DILocation(line: 30, column: 31, scope: !51)
!68 = !DILocation(line: 30, column: 34, scope: !51)
!69 = !DILocation(line: 30, column: 14, scope: !51)
!70 = !DILocation(line: 32, column: 5, scope: !51)
!71 = !DILocation(line: 34, column: 12, scope: !51)
!72 = !DILocation(line: 34, column: 5, scope: !51)
!73 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 38, type: !74, isLocal: false, isDefinition: true, scopeLine: 39, isOptimized: false, unit: !0, variables: !2)
!74 = !DISubroutineType(types: !75)
!75 = !{!10}
!76 = !DILocalVariable(name: "not_tainted", scope: !73, file: !1, line: 40, type: !34)
!77 = !DILocation(line: 40, column: 11, scope: !73)
!78 = !DILocalVariable(name: "tainted", scope: !73, file: !1, line: 41, type: !34)
!79 = !DILocation(line: 41, column: 11, scope: !73)
!80 = !DILocation(line: 41, column: 21, scope: !73)
!81 = !DILocalVariable(name: "rc", scope: !73, file: !1, line: 43, type: !10)
!82 = !DILocation(line: 43, column: 9, scope: !73)
!83 = !DILocation(line: 43, column: 33, scope: !73)
!84 = !DILocation(line: 43, column: 42, scope: !73)
!85 = !DILocation(line: 43, column: 55, scope: !73)
!86 = !DILocation(line: 43, column: 64, scope: !73)
!87 = !DILocation(line: 43, column: 77, scope: !73)
!88 = !DILocation(line: 43, column: 14, scope: !73)
!89 = !DILocation(line: 45, column: 12, scope: !73)
!90 = !DILocation(line: 45, column: 5, scope: !73)
