...
do.cond2:                                         ; preds = %do.end
  %call3 = call i32 @getenv(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0)), !dbg !28
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/061-do-while-loop-2")
!2 = !{}
...
!21 = !DILocation(line: 13, column: 23, scope: !18)
