...
do.body:                                          ; preds = %do.cond, %entry
  ...
  br label %do.cond, !dbg !19

do.cond:                                          ; preds = %do.body
  %call = call i32 @getenv(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0)), !dbg !20
  %tobool = icmp ne i32 %call, 0, !dbg !19
  br i1 %tobool, label %do.body, label %do.end, !dbg !19, !llvm.loop !15
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/061-do-while-loop-1")
!2 = !{}
