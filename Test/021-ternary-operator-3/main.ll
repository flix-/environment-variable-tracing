...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ 0, %cond.true ], [ %call1, %cond.false ], !dbg !14
  ...
  call void @llvm.dbg.declare(metadata i32* %ut, metadata !20, metadata !12), !dbg !21
  store i32 1, i32* %ut, align 4, !dbg !21
  ret i32 0, !dbg !22
}
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/021-ternary-operator-3")
!2 = !{}
...
!20 = !DILocalVariable(name: "ut", scope: !7, file: !1, line: 11, type: !10)
