...
if.end10:                                         ; preds = %if.end9, %if.end
  ...
  %1 = load i32, i32* %taint, align 4, !dbg !41
  %tobool11 = icmp ne i32 %1, 0, !dbg !41
  br i1 %tobool11, label %if.then12, label %if.else13, !dbg !43

if.then12:                                        ; preds = %if.end10
  store i32 0, i32* %a, align 4, !dbg !44
  br label %if.end14, !dbg !46
...
if.end14:                                         ; preds = %if.else13, %if.then12
  %2 = load i32, i32* %rc, align 4, !dbg !49
  ret i32 %2, !dbg !50
}
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/031-if-11")
!2 = !{}
...
!42 = distinct !DILexicalBlock(scope: !7, file: !1, line: 26, column: 9)
!43 = !DILocation(line: 26, column: 9, scope: !7)
!44 = !DILocation(line: 27, column: 11, scope: !45)
!45 = distinct !DILexicalBlock(scope: !42, file: !1, line: 26, column: 16)
!46 = !DILocation(line: 28, column: 5, scope: !45)
!47 = !DILocation(line: 29, column: 11, scope: !48)
!48 = distinct !DILexicalBlock(scope: !42, file: !1, line: 28, column: 12)
!49 = !DILocation(line: 32, column: 12, scope: !7)
!50 = !DILocation(line: 32, column: 5, scope: !7)
