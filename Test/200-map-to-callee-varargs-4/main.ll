...
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %ut, metadata !74, metadata !12), !dbg !75
  store i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i8** %ut, align 8, !dbg !75
  %0 = load i8*, i8** %t, align 8, !dbg !76
  %1 = load i8*, i8** %ut, align 8, !dbg !77
  call void (i32, ...) @foo(i32 1, i8* %0, i8* %1), !dbg !78
  ret i32 0, !dbg !79
}
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/200-map-to-callee-varargs-4")
!2 = !{}
...
!16 = !DIFile(filename: "/home/sebastian/documents/programming/llvm/jail/llvm501-debug/lib/clang/5.0.1/include/stdarg.h", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/200-map-to-callee-varargs-4")
...
!74 = !DILocalVariable(name: "ut", scope: !68, file: !1, line: 39, type: !40)
!75 = !DILocation(line: 39, column: 11, scope: !68)
!76 = !DILocation(line: 41, column: 12, scope: !68)
!77 = !DILocation(line: 41, column: 15, scope: !68)
!78 = !DILocation(line: 41, column: 5, scope: !68)
!79 = !DILocation(line: 43, column: 5, scope: !68)
