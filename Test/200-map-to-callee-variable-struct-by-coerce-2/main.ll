...
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %tainted, metadata !24, metadata !20), !dbg !25
  %tainted1 = getelementptr inbounds %struct.s1, %struct.s1* %fs, i32 0, i32 2, !dbg !26
  %0 = load i8*, i8** %tainted1, align 8, !dbg !26
  store i8* %0, i8** %tainted, align 8, !dbg !25
  ...
  %tainted11 = getelementptr inbounds %struct.s1, %struct.s1* %fs, i32 0, i32 2, !dbg !30
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i8** %tainted11, align 8, !dbg !31
  call void @llvm.dbg.declare(metadata i8** %not_tainted2, metadata !32, metadata !20), !dbg !33
  %tainted12 = getelementptr inbounds %struct.s1, %struct.s1* %fs, i32 0, i32 2, !dbg !34
  %2 = load i8*, i8** %tainted12, align 8, !dbg !34
  store i8* %2, i8** %not_tainted2, align 8, !dbg !33
  ret void, !dbg !35
}
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/200-map-to-callee-variable-struct-by-coerce-2")
!2 = !{}
...
!24 = !DILocalVariable(name: "tainted", scope: !7, file: !1, line: 13, type: !16)
!25 = !DILocation(line: 13, column: 11, scope: !7)
!26 = !DILocation(line: 13, column: 24, scope: !7)
...
!32 = !DILocalVariable(name: "not_tainted2", scope: !7, file: !1, line: 16, type: !16)
!33 = !DILocation(line: 16, column: 11, scope: !7)
!34 = !DILocation(line: 16, column: 29, scope: !7)
