...
cond.false:                                       ; preds = %entry
  %call2 = call i32 @getenv(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0)), !dbg !17
  br label %cond.end, !dbg !14

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %call1, %cond.true ], [ %call2, %cond.false ], !dbg !14
  ...
  call void @llvm.dbg.declare(metadata i32* %ut, metadata !21, metadata !12), !dbg !22
  store i32 1, i32* %ut, align 4, !dbg !22
  ret i32 0, !dbg !23
}
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/021-ternary-operator-6")
!2 = !{}
...
!16 = !DILocation(line: 8, column: 30, scope: !7)
!17 = !DILocation(line: 8, column: 38, scope: !7)
...
!21 = !DILocalVariable(name: "ut", scope: !7, file: !1, line: 11, type: !10)
