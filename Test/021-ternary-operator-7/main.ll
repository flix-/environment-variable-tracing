...
entry:
  ...
  %cmp = icmp eq i32 %call1, 0, !dbg !18
  br i1 %cmp, label %cond.true, label %cond.false, !dbg !17

cond.true:                                        ; preds = %entry
  %call2 = call i32 (...) @bar(), !dbg !19
  %conv = sext i32 %call2 to i64, !dbg !19
  %0 = inttoptr i64 %conv to i32*, !dbg !19
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32* [ %0, %cond.true ], [ %tainted, %cond.false ], !dbg !17
  %1 = ptrtoint i32* %cond to i32, !dbg !17
  store i32 %1, i32* %taint, align 4, !dbg !16
  call void @llvm.dbg.declare(metadata i32* %a, metadata !20, metadata !12), !dbg !21
  %2 = load i32, i32* %taint, align 4, !dbg !22
  store i32 %2, i32* %a, align 4, !dbg !21
  call void @llvm.dbg.declare(metadata i32* %ut, metadata !23, metadata !12), !dbg !24
  store i32 1, i32* %ut, align 4, !dbg !24
  ret i32 0, !dbg !25
}
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/021-ternary-operator-7")
!2 = !{}
...
!18 = !DILocation(line: 9, column: 23, scope: !7)
!19 = !DILocation(line: 9, column: 30, scope: !7)
...
!23 = !DILocalVariable(name: "ut", scope: !7, file: !1, line: 12, type: !10)
