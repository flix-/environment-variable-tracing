...
vaarg.end:                                        ; preds = %vaarg.in_mem, %vaarg.in_reg
  ...
  call void @llvm.dbg.declare(metadata i8** %t, metadata !53, metadata !31), !dbg !54
  ...
  store i8* %7, i8** %t, align 8, !dbg !54
  ret void, !dbg !57
}
...
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.s4* %ss, metadata !66, metadata !31), !dbg !67
  %s3 = getelementptr inbounds %struct.s1, %struct.s1* %s, i32 0, i32 0, !dbg !68
  %vas4 = getelementptr inbounds %struct.s2, %struct.s2* %s3, i32 0, i32 0, !dbg !68
  %arraydecay5 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %vas4, i32 0, i32 0, !dbg !68
  %gp_offset_p = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %arraydecay5, i32 0, i32 0, !dbg !68
  %gp_offset = load i32, i32* %gp_offset_p, align 8, !dbg !68
  %fits_in_gp = icmp ule i32 %gp_offset, 40, !dbg !68
  br i1 %fits_in_gp, label %vaarg.in_reg, label %vaarg.in_mem, !dbg !68

vaarg.in_reg:                                     ; preds = %entry
  %0 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %arraydecay5, i32 0, i32 3, !dbg !68
  %reg_save_area = load i8*, i8** %0, align 8, !dbg !68
  %1 = getelementptr i8, i8* %reg_save_area, i32 %gp_offset, !dbg !68
  %2 = bitcast i8* %1 to %struct.s5**, !dbg !68
  %3 = add i32 %gp_offset, 8, !dbg !68
  store i32 %3, i32* %gp_offset_p, align 8, !dbg !68
  br label %vaarg.end, !dbg !68

vaarg.in_mem:                                     ; preds = %entry
  %overflow_arg_area_p = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %arraydecay5, i32 0, i32 2, !dbg !68
  %overflow_arg_area = load i8*, i8** %overflow_arg_area_p, align 8, !dbg !68
  %4 = bitcast i8* %overflow_arg_area to %struct.s5**, !dbg !68
  %overflow_arg_area.next = getelementptr i8, i8* %overflow_arg_area, i32 8, !dbg !68
  store i8* %overflow_arg_area.next, i8** %overflow_arg_area_p, align 8, !dbg !68
  br label %vaarg.end, !dbg !68

vaarg.end:                                        ; preds = %vaarg.in_mem, %vaarg.in_reg
  %vaarg.addr = phi %struct.s5** [ %2, %vaarg.in_reg ], [ %4, %vaarg.in_mem ], !dbg !68
  %5 = load %struct.s5*, %struct.s5** %vaarg.addr, align 8, !dbg !68
  %s5 = getelementptr inbounds %struct.s4, %struct.s4* %ss, i32 0, i32 4, !dbg !69
  store %struct.s5* %5, %struct.s5** %s5, align 8, !dbg !70
  call void @llvm.dbg.declare(metadata i8** %t1, metadata !71, metadata !31), !dbg !72
  %s56 = getelementptr inbounds %struct.s4, %struct.s4* %ss, i32 0, i32 4, !dbg !73
  %6 = load %struct.s5*, %struct.s5** %s56, align 8, !dbg !73
  %t17 = getelementptr inbounds %struct.s5, %struct.s5* %6, i32 0, i32 0, !dbg !74
  %7 = load i8*, i8** %t17, align 8, !dbg !74
  store i8* %7, i8** %t1, align 8, !dbg !72
  call void @foo(%struct.s1* byval align 8 %s), !dbg !75
  %s8 = getelementptr inbounds %struct.s1, %struct.s1* %s, i32 0, i32 0, !dbg !76
  %vas9 = getelementptr inbounds %struct.s2, %struct.s2* %s8, i32 0, i32 0, !dbg !76
  %arraydecay10 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %vas9, i32 0, i32 0, !dbg !76
  %arraydecay1011 = bitcast %struct.__va_list_tag* %arraydecay10 to i8*, !dbg !76
  call void @llvm.va_end(i8* %arraydecay1011), !dbg !76
  ret i32 0, !dbg !77
}
...
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.s4* %s, metadata !81, metadata !31), !dbg !82
  call void @llvm.dbg.declare(metadata %struct.s5* %ss, metadata !83, metadata !31), !dbg !84
  ...
  call void @llvm.dbg.declare(metadata i32* %rc, metadata !91, metadata !31), !dbg !92
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/200-map-to-callee-varargs-34")
!2 = !{}
...
!17 = !DIFile(filename: "/home/sebastian/documents/programming/llvm/jail/llvm501-debug/lib/clang/5.0.1/include/stdarg.h", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/200-map-to-callee-varargs-34")
...
!53 = !DILocalVariable(name: "t", scope: !7, file: !1, line: 32, type: !40)
!54 = !DILocation(line: 32, column: 11, scope: !7)
!55 = !DILocation(line: 32, column: 18, scope: !7)
!56 = !DILocation(line: 32, column: 22, scope: !7)
...
!66 = !DILocalVariable(name: "ss", scope: !58, file: !1, line: 42, type: !34)
!67 = !DILocation(line: 42, column: 15, scope: !58)
!68 = !DILocation(line: 43, column: 13, scope: !58)
!69 = !DILocation(line: 43, column: 8, scope: !58)
!70 = !DILocation(line: 43, column: 11, scope: !58)
!71 = !DILocalVariable(name: "t1", scope: !58, file: !1, line: 45, type: !40)
!72 = !DILocation(line: 45, column: 11, scope: !58)
!73 = !DILocation(line: 45, column: 19, scope: !58)
!74 = !DILocation(line: 45, column: 23, scope: !58)
!75 = !DILocation(line: 47, column: 5, scope: !58)
!76 = !DILocation(line: 49, column: 5, scope: !58)
!77 = !DILocation(line: 51, column: 5, scope: !58)
!78 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 55, type: !79, isLocal: false, isDefinition: true, scopeLine: 56, isOptimized: false, unit: !0, variables: !2)
!79 = !DISubroutineType(types: !80)
!80 = !{!37}
!81 = !DILocalVariable(name: "s", scope: !78, file: !1, line: 57, type: !34)
!82 = !DILocation(line: 57, column: 15, scope: !78)
!83 = !DILocalVariable(name: "ss", scope: !78, file: !1, line: 58, type: !45)
!84 = !DILocation(line: 58, column: 15, scope: !78)
!85 = !DILocation(line: 59, column: 7, scope: !78)
!86 = !DILocation(line: 59, column: 10, scope: !78)
!87 = !DILocation(line: 61, column: 16, scope: !78)
!88 = !DILocation(line: 61, column: 7, scope: !78)
!89 = !DILocation(line: 61, column: 11, scope: !78)
!90 = !DILocation(line: 61, column: 14, scope: !78)
!91 = !DILocalVariable(name: "rc", scope: !78, file: !1, line: 63, type: !37)
!92 = !DILocation(line: 63, column: 9, scope: !78)
!93 = !DILocation(line: 63, column: 30, scope: !78)
!94 = !DILocation(line: 63, column: 14, scope: !78)
!95 = !DILocation(line: 65, column: 12, scope: !78)
!96 = !DILocation(line: 65, column: 5, scope: !78)
