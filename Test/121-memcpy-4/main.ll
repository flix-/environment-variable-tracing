...
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %tainted2, metadata !32, metadata !23), !dbg !33
  ...
  store i8* %2, i8** %tainted2, align 8, !dbg !33
  call void @llvm.dbg.declare(metadata i8** %not_tainted, metadata !36, metadata !23), !dbg !37
  %tainted5 = getelementptr inbounds %struct.s1, %struct.s1* %s2, i32 0, i32 2, !dbg !38
  %3 = load i8*, i8** %tainted5, align 8, !dbg !38
  store i8* %3, i8** %not_tainted, align 8, !dbg !37
  ret i32 0, !dbg !39
}
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/121-memcpy-4")
!2 = !{}
...
!32 = !DILocalVariable(name: "tainted", scope: !7, file: !1, line: 27, type: !19)
!33 = !DILocation(line: 27, column: 11, scope: !7)
!34 = !DILocation(line: 27, column: 24, scope: !7)
!35 = !DILocation(line: 27, column: 26, scope: !7)
!36 = !DILocalVariable(name: "not_tainted", scope: !7, file: !1, line: 28, type: !19)
!37 = !DILocation(line: 28, column: 11, scope: !7)
!38 = !DILocation(line: 28, column: 28, scope: !7)
!39 = !DILocation(line: 30, column: 5, scope: !7)
