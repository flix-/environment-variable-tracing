...
if.else:                                          ; preds = %entry
  call void @llvm.dbg.declare(metadata i32* %b, metadata !24, metadata !14), !dbg !26
  store i32 1, i32* %b, align 4, !dbg !26
  call void @abort() #5, !dbg !27
  unreachable, !dbg !27

if.end:                                           ; preds = %if.then
  call void @llvm.dbg.declare(metadata i32* %a1, metadata !28, metadata !14), !dbg !29
  store i32 0, i32* %a1, align 4, !dbg !29
  ret i32 0, !dbg !30
}
...
!24 = !DILocalVariable(name: "b", scope: !25, file: !1, line: 12, type: !10)
!25 = distinct !DILexicalBlock(scope: !18, file: !1, line: 11, column: 12)
!26 = !DILocation(line: 12, column: 13, scope: !25)
!27 = !DILocation(line: 13, column: 9, scope: !25)
!28 = !DILocalVariable(name: "a", scope: !7, file: !1, line: 16, type: !10)
!29 = !DILocation(line: 16, column: 9, scope: !7)
!30 = !DILocation(line: 18, column: 5, scope: !7)
