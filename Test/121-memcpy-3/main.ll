...
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %not_tainted1, metadata !17, metadata !14), !dbg !18
  store i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i8** %not_tainted1, align 8, !dbg !18
  %0 = load i8*, i8** %tainted, align 8, !dbg !19
  %1 = load i8*, i8** %not_tainted1, align 8, !dbg !20
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %0, i8* %1, i64 3, i32 1, i1 false), !dbg !21
  call void @llvm.dbg.declare(metadata i8** %not_tainted2, metadata !22, metadata !14), !dbg !23
  %2 = load i8*, i8** %tainted, align 8, !dbg !24
  store i8* %2, i8** %not_tainted2, align 8, !dbg !23
  ret i32 0, !dbg !25
}
...
!1 = !DIFile(filename: "main.c", directory: "/home/sebastian/.qt-creator-workspace/Phasar/Test/121-memcpy-3")
!2 = !{}
...
!17 = !DILocalVariable(name: "not_tainted1", scope: !7, file: !1, line: 11, type: !12)
!18 = !DILocation(line: 11, column: 11, scope: !7)
!19 = !DILocation(line: 13, column: 12, scope: !7)
!20 = !DILocation(line: 13, column: 21, scope: !7)
!21 = !DILocation(line: 13, column: 5, scope: !7)
!22 = !DILocalVariable(name: "not_tainted2", scope: !7, file: !1, line: 15, type: !12)
!23 = !DILocation(line: 15, column: 11, scope: !7)
!24 = !DILocation(line: 15, column: 26, scope: !7)
